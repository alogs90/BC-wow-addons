--[[
	...
	Revision: $Id: BarkerManifest.lua 2193 2007-09-18 06:10:48Z mentalpower $
...
EnchantrixBarker_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/RC_5.0/Enchantrix-Barker/BarkerManifest.lua $", "$Rev: 2193 $")
